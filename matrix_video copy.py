...
# === Instellingen ===
matrix_chars = list("アィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモヤャユュヨョラリルレロワヲンヴヵヶーァィゥェォッャュョヮヽヾㇰㇱㇲㇳㇴㇵㇶㇷㇸㇹㇺㇻㇼㇽㇾㇿ0123456789")
...
grid_cols = 25
output_fps = 60
output_video = "matrix_silhouette_output_3.mp4"
